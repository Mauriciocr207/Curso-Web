...
CREATE TABLE `eventos` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_eventos_id_categoria_idx` (`id_categoria`),
  KEY `fk_eventos_id_dia_idx` (`id_dia`),
  KEY `fk_eventos_id_hora_idx` (`id_hora`),
  KEY `fk_eventos_id_ponente_idx` (`id_ponente`),
  CONSTRAINT `fk_eventos_id_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `fk_eventos_id_dia` FOREIGN KEY (`id_dia`) REFERENCES `dias` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `fk_eventos_id_hora` FOREIGN KEY (`id_hora`) REFERENCES `horas` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `fk_eventos_id_ponente` FOREIGN KEY (`id_ponente`) REFERENCES `ponentes` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
...
CREATE TABLE `eventos_registros` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_eventos_registro_id_evento_idx` (`id_evento`),
  KEY `fk_eventos_registro_id_registro_idx` (`id_registro`),
  CONSTRAINT `fk_eventos_registro_id_evento` FOREIGN KEY (`id_evento`) REFERENCES `eventos` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `fk_eventos_registro_id_registro` FOREIGN KEY (`id_registro`) REFERENCES `registros` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
...
CREATE TABLE `horas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hora` varchar(13) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `registros` (
  ...
  `id_pago` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_usuario` int DEFAULT NULL,
  `id_regalo` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_registro_id_usuario_idx` (`id_usuario`),
  KEY `fk_registro_id_paquete_idx` (`id_paquete`),
  KEY `id_reagalo` (`id_regalo`),
  CONSTRAINT `fk_registro_id_paquete` FOREIGN KEY (`id_paquete`) REFERENCES `paquetes` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `fk_registro_id_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `registros_ibfk_1` FOREIGN KEY (`id_regalo`) REFERENCES `regalos` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
...
INSERT INTO `registros` VALUES (16,'af997032',1,'6KG26275JW497063W',8,NULL);
...
INSERT INTO `usuarios` VALUES (8,'Enrique Mauricio','Romero','mauriciocr123@outlook.com','$2y$10$.bVmZRvCL77vWgvh/Ktxh.0/QgOdMX2t3KEpc79SuYTx8LCZ.XGve',1,'',0);
...
-- Dump completed on 2023-06-27 13:33:44
